...
<div id="product-main" class="product-main">
 ...
 $search=trim($search);
   ...
   $all=mysqli_query($conn,"SELECT * FROM `products` WHERE `Status`='Active' AND `Category` LIKE '%{$search}%' OR `ProductName` LIKE '%{$search}%' OR `Category`='$search'");
...
<div class="product-inner">
  <div class="product-image"> 
    ...
    <div class="links-on-image">
      <div class="add-links-wrap">
        <!-- <div class="add-links clearfix"><a href="../products/gentle-shoes95b3.html?view=quickview" class="action-list quickview-icon quickview"> 
  ...
  <a href="#" title=""></a></span><a class="product-loop-title" href="viewproduct.php?pid=<?php echo $row['Product_ID']; ?>">
    ...
    <!-- <div class="rating-wrap">
      <div class="rating-content">
        <span class="shopify-product-reviews-badge" data-id="4748716048446"></span>
      </div>
    </div> -->
...
<div class="checkout-cart text-center">
  ...
  <img src="cartlog/noimg" height="500px" width="500px">
