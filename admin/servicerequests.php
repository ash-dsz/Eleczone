...
<div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">New Service Requests</h4>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <?php
                                         ...
                                         if(mysqli_num_rows($result)>0){
                                            ...
                                            ?>
                                            <tr>
                                                <td><a href="assign.php?serviceid=<?php echo $row['Service_ID']  ?>"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#primary-header-modal">Assign</button></td></a>
